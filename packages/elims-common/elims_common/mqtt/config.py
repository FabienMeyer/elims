...
class MQTTConfig(BaseModel):
    ...
    username: Username | None = Field(default=None, description="MQTT username for authentication")
    password: SecretStr | None = Field(default=None, description="MQTT password for authentication")
    ...
    tls_insecure: bool = Field(default=False, description="Disable SSL certificate verification (only for development)")
