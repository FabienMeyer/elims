...
from elims.api.modules.authenticator.exceptions import HTTP_401_UNAUTHORIZED, HTTP_403_FORBIDDEN
...
class AuthenticatorService:
    ...
    async def get_current_user(self, security_scopes: SecurityScopes, token: str) -> UserRead:
        ...
        Raises:
            HTTP_401_UNAUTHORIZED: If the token is invalid or expired.
            HTTP_403_FORBIDDEN: If user lacks required scopes.
        ...
        try:
            ...
            raise HTTP_401_UNAUTHORIZED from None
