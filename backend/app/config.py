...
class Settings(BaseSettings):
    ...
    mqtt_username: str = Field(default="elims-backend-subscriber", description="MQTT username for backend service")
    ...
    mqtt_tls_insecure: bool = Field(default=True, description="Disable SSL certificate verification for self-signed certs (development only)")
