...
class Settings(BaseSettings):
    ...
    mqtt_certificate_authority_file: Path = Field(description="Path to MQTT CA certificate file")
    mqtt_certificate_file: Path = Field(description="Path to MQTT client certificate file")
    mqtt_key_file: Path = Field(description="Path to MQTT client key file")
